...
const styles = {
  ...
  main: { flex:1, overflowY:'auto', padding:'20px 16px', backgroundColor: '#cff1ff' },
  mainHeader: { display:'flex', justifyContent:'space-between', alignItems:'center', flexWrap:'wrap', gap:'12px', marginBottom:'24px' },
  ...
  scheduleBox: { backgroundColor:'rgba(255, 255, 255, 0.6)', backdropFilter: 'blur(8px)', borderRadius:'16px', padding:'20px 16px', marginBottom:'32px', border:'1px solid rgba(255, 255, 255, 0.5)' },
  scheduleTitle: { fontSize:'16px', fontWeight:'700', color:'#004e77', marginBottom:'20px', display:'flex', alignItems:'center', gap:'8px' },
  classItem: { display:'flex', justifyContent:'space-between', alignItems:'center', flexWrap:'wrap', gap:'10px', padding:'14px 16px', backgroundColor:'white', borderRadius:'12px', border:'1px solid #e2e8f0', marginBottom:'8px' },
  ...
  modalOverlay: { position:'fixed', inset:0, backgroundColor:'rgba(0, 78, 119, 0.3)', backdropFilter:'blur(4px)', display:'flex', alignItems:'center', justifyContent:'center', zIndex:100, padding:'16px' },
  modal: { backgroundColor:'white', padding:'24px', borderRadius:'20px', width:'92%', maxWidth:'440px', boxSizing:'border-box', border:'1px solid #e2e8f0', boxShadow:'0 20px 60px rgba(0,0,0,0.1)' },
